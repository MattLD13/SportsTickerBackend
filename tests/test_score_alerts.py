...
from sports_ticker.services.score_alerts import ScoreAlertTracker, describe_score, normalize_last_play
...
def test_mlb_id_only_last_play_resolves_the_scoring_play():
    play = {
        'id': 'score-1',
        'text': 'Sanoja homered to left (388 feet), Lopez scored.',
        'type': {'text': 'Play Result'},
        'scoreValue': 2,
        'team': {'id': 'NYY'},
    }
    normalized = normalize_last_play(
        {'id': 'next-batter'},
        home_abbr='NYY', away_abbr='BOS', home_id='NYY', away_id='BOS',
        plays=[play, {'id': 'next-batter', 'text': 'Start Batter/Pitcher', 'scoreValue': 0}],
    )

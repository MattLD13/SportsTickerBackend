...
# --- LOAD VALID TEAMS ---
# This ensures we only sort teams into categories if they are explicitly listed
try:
        ...
        for league_key, config in self.leagues.items():
            ...
            try:
                ...
                for event in data.get('events', []):
                    ...
                    # Ensure games only show if they match valid FBS/FCS lists
                    ...
                    if home_abbr in LOGO_OVERRIDES: home_logo_url = LOGO_OVERRIDES[home_abbr]
                    if away_abbr in LOGO_OVERRIDES: away_logo_url = LOGO_OVERRIDES[away_abbr]

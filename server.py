...
def serve_logo(league, abbr):
    url = None
    override_key = f"{league}_{abbr}".upper()
    if override_key in LOGO_OVERRIDES: url = LOGO_OVERRIDES[override_key]
    elif abbr in LOGO_OVERRIDES: url = LOGO_OVERRIDES[abbr]
    else:
        target_leagues = []

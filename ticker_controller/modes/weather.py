...
class WeatherMixin:
    ...
    def draw_weather_detailed(self, game):
        ...
        icon_for_render = str(cur_icon).lower()
        if is_night and ('sun' in icon_for_render or 'clear' in icon_for_render):
            icon_for_render = 'moon'
        ...
        def draw_amb(icon, rx, ry, rw, rh, t, dim=1.0, density=1.0, wind=0.0):
            ...
            if 'rain' in ic or 'storm' in ic:
                ...
                # A 51px forecast column only had 5 streak positions, which
        ...
        self.draw_weather_pixel_art(d, icon_for_render, 3, 11, t=anim_t)
        ...
        for i, day in enumerate(forecast[:5]):
            ...
            if gust is not None:
                ...
                # to what actually turns up — daily maxima cluster around

...
from .routes.metadata import api_blank_logo, api_spotify, get_league_options, get_mode_options
...
__all__ = [
    ...
    'api_blank_logo', 'api_spotify', 'get_league_options', 'get_mode_options',

...
default_state = {
    'active_sports': { 
        ...
        'soccer_epl': True, 'soccer_mls': True, 'golf': True,
        'weather': False, 'clock': False 
    },
    'mode': 'all', 
    'layout_mode': 'schedule',
    'scroll_seamless': False,
    'my_teams': ["NYG", "NYY", "NJD", "NYK", "LAL", "BOS", "KC", "BUF", "LEH", "LIV", "MCI", "TOT", "ARS"], 
    'current_games': [],
    'all_teams_data': {}, 
    'debug_mode': False,
    'custom_date': None,
    'brightness': 0.5,
    'scroll_speed': 5, # 1-10 Scale
    'inverted': False,
    'panel_count': 2,
    'test_pattern': False,
...
SPORT_DURATIONS = {
    ...
    'soccer_epl': 110, 'soccer_mls': 110, 'golf': 720
}
    ...
    <body>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="control-group">
                ...
                <div class="toggle-row"><span>EPL (Soccer)</span><label class="switch"><input type="checkbox" id="chk_soccer_epl"><span class="slider"></span></label></div>
                <div class="toggle-row"><span>MLS (Soccer)</span><label class="switch"><input type="checkbox" id="chk_soccer_mls"><span class="slider"></span></label></div>
                <div class="toggle-row"><span>PGA (Golf)</span><label class="switch"><input type="checkbox" id="chk_golf"><span class="slider"></span></label></div>
            ...
            <div class="control-group">
                ...
                <input type="text" id="inp_loc" placeholder="Zip or City" style="margin-top:10px;">
                <select id="sel_timezone" style="margin-top:5px;">
        ...
        <script>
            ...
            function renderGrid(games) {
                ...
                games.forEach(game => {
                    ...
                    if(game.sport === 'golf') return; // Skip golf in grid for now, or implement custom card
            ...
            function renderSchedule(games, utcOffset) {
                ...
                games.forEach(g => {
                    if(g.sport === 'weather' || g.sport === 'clock' || g.sport === 'golf') return;
            ...
            async function saveSettings() {
                ...
                const payload = {
                    active_sports: {
                        ...
                        soccer_epl: document.getElementById('chk_soccer_epl').checked, soccer_mls: document.getElementById('chk_soccer_mls').checked, golf: document.getElementById('chk_golf').checked, ncf_fbs: document.getElementById('chk_ncf_fbs').checked,
                        weather: document.getElementById('chk_weather').checked, clock: document.getElementById('chk_clock').checked
                    },
                    my_teams: teamsArr,
